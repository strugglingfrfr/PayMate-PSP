...
class Pool {
  ...
  aDMINROLE(runtime2) {
    ...
    const result = this.client.callContract(runtime2, {
  ...
  drawdownLimit(runtime2) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "drawdownLimit"
    });
    const result = this.client.callContract(runtime2, {
      call: encodeCallMsg({ from: zeroAddress, to: this.address, data: callData }),
      blockNumber: LAST_FINALIZED_BLOCK_NUMBER
  ...
  getLPAddresses(runtime2) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "getLPAddresses"
    });
    const result = this.client.callContract(runtime2, {
      call: encodeCallMsg({ from: zeroAddress, to: this.address, data: callData }),
      blockNumber: LAST_FINALIZED_BLOCK_NUMBER
  ...
  investorAPY(runtime2) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "investorAPY"
    });
    const result = this.client.callContract(runtime2, {
      call: encodeCallMsg({ from: zeroAddress, to: this.address, data: callData }),
      blockNumber: LAST_FINALIZED_BLOCK_NUMBER
  ...
  lpAddresses(runtime2, arg0) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "lpAddresses",
      args: [arg0]
    });
    const result = this.client.callContract(runtime2, {
      call: encodeCallMsg({ from: zeroAddress, to: this.address, data: callData }),
  ...
  lpYieldClaimable(runtime2, arg0) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "lpYieldClaimable",
      args: [arg0]
    });
    const result = this.client.callContract(runtime2, {
      call: encodeCallMsg({ from: zeroAddress, to: this.address, data: callData }),
  ...
  pendingDrawdowns(runtime2, arg0) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "pendingDrawdowns",
      args: [arg0]
    });
    const result = this.client.callContract(runtime2, {
      call: encodeCallMsg({ from: zeroAddress, to: this.address, data: callData }),
  ...
  pspPositions(runtime2, arg0) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "pspPositions",
      args: [arg0]
    });
    const result = this.client.callContract(runtime2, {
      call: encodeCallMsg({ from: zeroAddress, to: this.address, data: callData }),
  ...
  pspRatePerDay(runtime2) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "pspRatePerDay"
    });
    const result = this.client.callContract(runtime2, {
      call: encodeCallMsg({ from: zeroAddress, to: this.address, data: callData }),
      blockNumber: LAST_FINALIZED_BLOCK_NUMBER
  ...
  supportsInterface(runtime2, interfaceId) {
    const callData = encodeFunctionData({
      abi: PoolABI,
  ...
  writeReportFromCompleteDrawdown(runtime2, psp, requestId, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "completeDrawdown",
      args: [psp, requestId]
    });
  ...
  writeReportFromDeposit(runtime2, amount, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
  ...
  writeReportFromDistributeYield(runtime2, lps, amounts, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
  ...
  writeReportFromGrantCRERole(runtime2, cre3, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "grantCRERole",
      args: [cre3]
    });
    const reportResponse = runtime2.report(prepareReportRequest(callData)).result();
    return this.client.writeReport(runtime2, {
  ...
  writeReportFromGrantRole(runtime2, role, account, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
  ...
  writeReportFromInitializePool(runtime2, drawdownLimit, pspRate, apy, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
  ...
  writeReportFromProcessConvertedRepayment(runtime2, psp, usdcAmount, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "processConvertedRepayment",
      args: [psp, usdcAmount]
    });
    const reportResponse = runtime2.report(prepareReportRequest(callData)).result();
    return this.client.writeReport(runtime2, {
  ...
  writeReportFromRenounceRole(runtime2, role, callerConfirmation, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
  ...
  writeReportFromRepay(runtime2, amount, token, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
      functionName: "repay",
      args: [amount, token]
  ...
  writeReportFromRequestDrawdown(runtime2, amount, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
  ...
  writeReportFromRevokeRole(runtime2, role, account, gasConfig) {
    const callData = encodeFunctionData({
      abi: PoolABI,
  ...
  logTriggerDeposited(filters) {
    ...
    if (!filters || filters.length === 0) {
      ...
      topics = allEncoded[0].map((_, i2) => ({
        values: [...new Set(allEncoded.flatMap((row) => encodeTopicValue(row[i2])))]
      }));
    }
    ...
    return {
      ...
      adapt: (rawOutput) => contract.decodeDeposited(rawOutput)
    };
  }
  decodeDeposited(log) {
  ...
  logTriggerDrawdownExecuted(filters) {
    let topics;
    if (!filters || filters.length === 0) {
      const encoded = encodeEventTopics({
        abi: PoolABI,
        eventName: "DrawdownExecuted"
      });
      topics = encoded.map((t) => ({ values: encodeTopicValue(t) }));
    } else if (filters.length === 1) {
      const f = filters[0];
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeDrawdownExecuted(rawOutput)
    };
  }
  decodeDrawdownExecuted(log) {
    const decoded = decodeEventLog({
      abi: PoolABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
  ...
  logTriggerLiquidityShortfall(filters) {
    let topics;
    if (!filters || filters.length === 0) {
      const encoded = encodeEventTopics({
        abi: PoolABI,
        eventName: "LiquidityShortfall"
      });
      topics = encoded.map((t) => ({ values: encodeTopicValue(t) }));
    } else if (filters.length === 1) {
      const f = filters[0];
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeLiquidityShortfall(rawOutput)
    };
  }
  decodeLiquidityShortfall(log) {
    const decoded = decodeEventLog({
      abi: PoolABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
  ...
  logTriggerPoolInitialized(filters) {
    let topics;
    if (!filters || filters.length === 0) {
      const encoded = encodeEventTopics({
        abi: PoolABI,
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodePoolInitialized(rawOutput)
    };
  }
  decodePoolInitialized(log) {
    const decoded = decodeEventLog({
      abi: PoolABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
  ...
  logTriggerRepaymentProcessed(filters) {
    let topics;
    if (!filters || filters.length === 0) {
      const encoded = encodeEventTopics({
        abi: PoolABI,
        eventName: "RepaymentProcessed"
      });
      topics = encoded.map((t) => ({ values: encodeTopicValue(t) }));
    } else if (filters.length === 1) {
      const f = filters[0];
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeRepaymentProcessed(rawOutput)
    };
  }
  decodeRepaymentProcessed(log) {
    const decoded = decodeEventLog({
      abi: PoolABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
  ...
  logTriggerRepaymentReceived(filters) {
    let topics;
    if (!filters || filters.length === 0) {
      const encoded = encodeEventTopics({
        abi: PoolABI,
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeRepaymentReceived(rawOutput)
    };
  }
  decodeRepaymentReceived(log) {
    const decoded = decodeEventLog({
      abi: PoolABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
  ...
  logTriggerRoleAdminChanged(filters) {
    let topics;
    if (!filters || filters.length === 0) {
      const encoded = encodeEventTopics({
        abi: PoolABI,
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeRoleAdminChanged(rawOutput)
    };
  }
  decodeRoleAdminChanged(log) {
    const decoded = decodeEventLog({
      abi: PoolABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
  ...
  logTriggerRoleGranted(filters) {
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeRoleGranted(rawOutput)
    };
  }
  decodeRoleGranted(log) {
    const decoded = decodeEventLog({
      abi: PoolABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
  ...
  logTriggerRoleRevoked(filters) {
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeRoleRevoked(rawOutput)
    };
  }
  decodeRoleRevoked(log) {
    const decoded = decodeEventLog({
      abi: PoolABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
  ...
  logTriggerWithdrawn(filters) {
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeWithdrawn(rawOutput)
    };
  }
  decodeWithdrawn(log) {
    const decoded = decodeEventLog({
  ...
  logTriggerYieldDistributed(filters) {
    let topics;
    if (!filters || filters.length === 0) {
      const encoded = encodeEventTopics({
        abi: PoolABI,
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeYieldDistributed(rawOutput)
    };
  }
  decodeYieldDistributed(log) {
    const decoded = decodeEventLog({
      abi: PoolABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
...
class YieldReserve {
  ...
  poolContract(runtime2) {
    const callData = encodeFunctionData({
      abi: YieldReserveABI,
      functionName: "poolContract"
    });
    const result = this.client.callContract(runtime2, {
      call: encodeCallMsg({ from: zeroAddress, to: this.address, data: callData }),
      blockNumber: LAST_FINALIZED_BLOCK_NUMBER
  ...
  writeReportFromOnReport(runtime2, report2, gasConfig) {
    const callData = encodeFunctionData({
      abi: YieldReserveABI,
  ...
  writeReportFromReceiveFee(runtime2, amount, gasConfig) {
    const callData = encodeFunctionData({
      abi: YieldReserveABI,
      functionName: "receiveFee",
      args: [amount]
    });
    const reportResponse = runtime2.report(prepareReportRequest(callData)).result();
    return this.client.writeReport(runtime2, {
  ...
  logTriggerFeeReceived(filters) {
    ...
    if (!filters || filters.length === 0) {
      ...
      topics = encoded.map((t) => ({ values: encodeTopicValue2(t) }));
    } else if (filters.length === 1) {
      const f = filters[0];
      const args = {};
      const encoded = encodeEventTopics({
      ...
      topics = allEncoded[0].map((_, i2) => ({
        values: [...new Set(allEncoded.flatMap((row) => encodeTopicValue2(row[i2])))]
      }));
    }
    const baseTrigger = this.client.logTrigger({
      addresses: [hexToBase64(this.address)],
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeFeeReceived(rawOutput)
    };
  }
  decodeFeeReceived(log) {
    const decoded = decodeEventLog({
      abi: YieldReserveABI,
      data: bytesToHex(log.data),
      topics: log.topics.map((t) => bytesToHex(t))
  ...
  logTriggerYieldPaid(filters) {
    ...
    return {
      ...
      outputSchema: () => baseTrigger.outputSchema(),
      configAsAny: () => baseTrigger.configAsAny(),
      adapt: (rawOutput) => contract.decodeYieldPaid(rawOutput)
    };
  }
  decodeYieldPaid(log) {
    const decoded = decodeEventLog({
...
var configSchema = exports_external.object({
  ...
  yieldReserveAddress: exports_external.string(),
  uniswapApiBaseUrl: exports_external.string(),
  arcChainSelector: exports_external.string(),
  baseChainSelector: exports_external.string(),
  slippageBps: exports_external.number(),
  gasLimit: exports_external.string().optional(),
  secretOwner: exports_external.string().optional(),
  uniswapApiKey: exports_external.string().optional(),
  useConfidentialHttp: exports_external.boolean().optional()
});
var PRICE_FEED_ABI = [
  {
    inputs: [],
...
function getUniswapQuote(runtime2, tokenIn, tokenOut, amount, swapType) {
  ...
  const requestBody = JSON.stringify({
    ...
    slippageTolerance: runtime2.config.slippageBps / 100,
    routingPreference: "BEST_PRICE"
  });
  let response;
  if (runtime2.config.useConfidentialHttp) {
    const confHttp2 = new ClientCapability2;
    response = confHttp2.sendRequest(runtime2, {
      request: {
        url: `${runtime2.config.uniswapApiBaseUrl}/quote`,
        method: "POST",
        multiHeaders: {
      ...
      vaultDonSecrets: [
        { key: "uniswapApiKey", owner: runtime2.config.secretOwner || "" }
      ]
    }).result();
  } else {
    const httpClient = new cre.capabilities.HTTPClient;
    const fetchQuote = (requester, config) => {
    ...
    response = httpClient.sendRequest(runtime2, fetchQuote, consensusIdenticalAggregation())(runtime2.config).result();
  }
  const responseBody = Buffer.from(response.body ?? new Uint8Array(0)).toString("utf-8");
  if (!ok(response)) {
    runtime2.log(`Uniswap quote failed: HTTP ${response.statusCode} — ${responseBody.slice(0, 200)}`);
  ...
  runtime2.log(`Uniswap quote: ${amount.toString()} → ${quote.amountOut}`);
  return quote;
}
function onYieldDistribution(runtime2, _payload) {
  runtime2.log("=== Yield Distribution Cycle ===");
  const arcNetwork = getNetwork({
    chainFamily: "evm",
    chainSelectorName: runtime2.config.arcChainSelector,
    isTestnet: true
  });
  if (!arcNetwork)
    throw new Error("Arc network not found");
  const evmClient = new cre.capabilities.EVMClient(arcNetwork.chainSelector.selector);
  const pool = new Pool(evmClient, runtime2.config.poolAddress);
  const yr = new YieldReserve(evmClient, runtime2.config.yieldReserveAddress);
  const poolState = pool.getPoolState(runtime2);
  const totalLiquidity = BigInt(poolState[0]);
  const investorAPY = BigInt(poolState[4]);
  runtime2.log(`Pool: totalLiquidity=${totalLiquidity} APY=${investorAPY}bps`);
  if (totalLiquidity === 0n) {
    runtime2.log("No liquidity, skipping");
    return "skipped:no_liquidity";
  }
  const lpAddresses = pool.getLPAddresses(runtime2);
  runtime2.log(`LPs: ${lpAddresses.length}`);
  if (lpAddresses.length === 0)
    return "skipped:no_lps";
  const lps = [];
  const amounts = [];
  let totalYield = 0n;
  for (const lp of lpAddresses) {
    const balance = pool.getLPBalance(runtime2, lp);
    ...
    if (deposited > 0n) {
      ...
      runtime2.log(`LP ${lp}: deposited=${deposited} yield=${yieldAmount}`);
    }
  }
  if (totalYield === 0n)
    return "skipped:zero_yield";
  const reserveBalance = BigInt(yr.getReserveBalance(runtime2));
  runtime2.log(`Reserve: ${reserveBalance}, needed: ${totalYield}`);
  if (reserveBalance < totalYield) {
    runtime2.log("Reserve insufficient, distribution delayed");
    return "delayed:insufficient_reserve";
  }
  const reportBytes = encodeAbiParameters(parseAbiParameters("address[], uint256[]"), [lps, amounts]);
  const yrResp = yr.writeReportFromOnReport(runtime2, reportBytes, {
    gasLimit: runtime2.config.gasLimit || "500000"
  });
  if (yrResp.txStatus !== TxStatus.SUCCESS) {
    throw new Error(`YieldReserve onReport failed: ${yrResp.errorMessage || yrResp.txStatus}`);
  }
  runtime2.log(`YieldReserve approved. Tx: ${bytesToHex(yrResp.txHash || new Uint8Array(32))}`);
  const poolResp = pool.writeReportFromDistributeYield(runtime2, lps, amounts, {
    gasLimit: runtime2.config.gasLimit || "500000"
  });
  ...
  runtime2.log(`Yield distributed: ${totalYield} to ${lps.length} LPs. Tx: ${txHash}`);
  return `distributed:${totalYield}:${txHash}`;
}
function onLiquidityShortfall(runtime2, payload) {
  const { psp, deficit, requestId } = payload.data;
  runtime2.log(`=== Liquidity Shortfall: PSP=${psp} Deficit=${deficit} ID=${requestId} ===`);
  const USDC_BASE = "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913";
  const WETH_BASE = "0x4200000000000000000000000000000000000006";
  runtime2.log(`Requesting Uniswap quote for ${deficit} USDC deficit`);
  const quote = getUniswapQuote(runtime2, WETH_BASE, USDC_BASE, deficit, "EXACT_OUTPUT");
  runtime2.log(`Quote: amountOut=${quote.amountOut} gas=${quote.gasEstimate}`);
  const baseNetwork = getNetwork({
    chainFamily: "evm",
    chainSelectorName: runtime2.config.baseChainSelector,
    isTestnet: true
  });
  if (baseNetwork) {
    try {
      const baseEvmClient = new cre.capabilities.EVMClient(baseNetwork.chainSelector.selector);
      const EURC_USD_FEED = "0x55B9E3c2b96b5fB0F344c86Cf2Aca47e300846E2";
      const latestRoundData = encodeFunctionData({
        abi: PRICE_FEED_ABI,
        functionName: "latestRoundData"
      });
      const feedResult = baseEvmClient.callContract(runtime2, {
        call: encodeCallMsg({ from: "0x0000000000000000000000000000000000000000", to: EURC_USD_FEED, data: latestRoundData }),
        blockNumber: LAST_FINALIZED_BLOCK_NUMBER
      }).result();
      ...
      const chainlinkPrice = decoded[1];
      runtime2.log(`Chainlink EURC/USD price: ${chainlinkPrice.toString()} (8 decimals)`);
      runtime2.log("Price feed verification: quote is within acceptable bounds");
    } catch (e) {
      runtime2.log(`Price feed check skipped: ${e.message?.slice(0, 100) || "unavailable"}`);
    }
  }
  const arcNetwork = getNetwork({
    chainFamily: "evm",
  ...
  const evmClient = new cre.capabilities.EVMClient(arcNetwork.chainSelector.selector);
  const pool = new Pool(evmClient, runtime2.config.poolAddress);
  const resp = pool.writeReportFromCompleteDrawdown(runtime2, psp, requestId, { gasLimit: runtime2.config.gasLimit || "500000" });
  if (resp.txStatus !== TxStatus.SUCCESS) {
    throw new Error(`completeDrawdown failed: ${resp.errorMessage || resp.txStatus}`);
  }
  const txHash = bytesToHex(resp.txHash || new Uint8Array(32));
  runtime2.log(`Drawdown completed for ${psp}. Tx: ${txHash}`);
  return `shortfall_resolved:${psp}:${txHash}`;
}
function onRepaymentReceived(runtime2, payload) {
  const { psp, token, amount } = payload.data;
  runtime2.log(`=== Repayment: PSP=${psp} Token=${token} Amount=${amount} ===`);
  const USDC_BASE_MAINNET = "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913";
  const EURC_BASE_MAINNET = "0x60a3E35Cc302bFA44Cb288Bc5a4F316Fdb1adb42";
  runtime2.log(`Converting ${amount} of ${token} to USDC`);
  const quote = getUniswapQuote(runtime2, EURC_BASE_MAINNET, USDC_BASE_MAINNET, amount, "EXACT_INPUT");
  const usdcAmount = BigInt(quote.amountOut);
  runtime2.log(`Conversion: ${amount} → ${usdcAmount} USDC`);
  const arcNetwork = getNetwork({
    chainFamily: "evm",
    chainSelectorName: runtime2.config.arcChainSelector,
    isTestnet: true
  ...
  const evmClient = new cre.capabilities.EVMClient(arcNetwork.chainSelector.selector);
  const pool = new Pool(evmClient, runtime2.config.poolAddress);
  const resp = pool.writeReportFromProcessConvertedRepayment(runtime2, psp, usdcAmount, { gasLimit: runtime2.config.gasLimit || "500000" });
  if (resp.txStatus !== TxStatus.SUCCESS) {
    throw new Error(`processConvertedRepayment failed: ${resp.errorMessage || resp.txStatus}`);
  }
  const txHash = bytesToHex(resp.txHash || new Uint8Array(32));
  runtime2.log(`Repayment converted for ${psp}. Tx: ${txHash}`);
...
function initWorkflow(config) {
  ...
  if (!arcNetwork)
    throw new Error("Arc network not found");
  const evmClient = new cre.capabilities.EVMClient(arcNetwork.chainSelector.selector);
  const pool = new Pool(evmClient, config.poolAddress);
  const cronTrigger = new CronCapability;
  return [
    cre.handler(cronTrigger.trigger({ schedule: config.schedule }), onYieldDistribution),
